...
%---------------------------------------------------
%	 PASSO 04 - MANUAL
%Sugere-se que o professor utilize, no processo de ensino-aprendizagem, metodologias
%apoiadas por ferramentas que estimulem o protagonismo do aluno como as metodologias
%ativas, assim como estratégias de avaliação que considerem, por exemplo, a taxonomia de
%Bloom revisada, a pirâmide de Glasser, os métodos ensino de competências proposto por Antoni
%Zabala e outros como elementos principais.
%
